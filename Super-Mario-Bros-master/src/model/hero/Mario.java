...
public class Mario extends GameObject{
    ...
    public void move(boolean toRight, Camera camera) {
        ...
        //Ngăn Mario di chuyển ra ngoài phạm vi mà camera đang hiển thị.
        //Điều này giúp đảm bảo Mario luôn nằm trong khu vực mà người chơi có thể nhìn thấy.
    ...
    public boolean onTouchEnemy(GameEngine engine){
        ...
        //khi mà mario đang ở trạng thái siêu hoặc lửa, khi va chạm với enemy thì camera sẽ rung và mario trở về trạng thái
        // bình thường.
        else{
            engine.shakeCamera();
            // trạng thái mario ở về trạng thái bình thường.
